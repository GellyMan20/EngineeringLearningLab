# Project 05 — Process vs Measurement Noise
#
# Purpose:
# This project demonstrates the engineering concepts behind Process vs Measurement Noise.
#
# Topics:
# - State estimation
# - Sensor fusion
...
def main():
    ...
    plt.title("Process vs Measurement Noise")
    plt.xlabel("Time [s]")
    plt.grid(True)
    plt.legend()
    plt.show()
