# Project 13 — Covariance Ellipse Evolution
#
# Purpose:
# This project demonstrates the engineering concepts behind Covariance Ellipse Evolution.
#
# Topics:
# - State estimation
# - Sensor fusion
...
def main():
    ...
    plt.title("Covariance Ellipse Evolution")
    plt.xlabel("Time [s]")
    plt.grid(True)
    plt.legend()
    plt.show()
